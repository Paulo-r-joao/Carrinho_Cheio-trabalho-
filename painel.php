  ...
  <div class="container" style="background-color: rgb(255,255,255)">
    ...
    <div class="ms-auto dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end">
        <li>
          <a class="dropdown-item submenu" href="#" data-bs-toggle="" data-bs-target="#configuracoes">
...
<div class="modal fade" id="modalUsuario" tabindex="-1" aria-labelledby="modalUsuarioLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content width-modal">
      <div class="modal-header" style='background-color:rgb(0,77,97);'>
        <h5 class="modal-title" id="modalUsuarioLabel" style='color:white;'>Meu Perfil</h5>
      ...
      <div class="modal-body">
        <div class="row mb-3">
          <div class="col-md-6">
            ...
            <input type="text" value="<?php echo $_SESSION['nm_nome'] ?? ''; ?>" readonly>
          </div>
          <div class="col-md-6">
            <label class="form-label">Login</label>
            <input type="text" value="<?php echo $_SESSION['nm_login'] ?? ''; ?>" readonly>
          </div>
        </div>
        ...
        <div class="row mb-3 align-items-center">
          <div class="col-md-8">
            ...
            <input type="email"  value="<?php echo $_SESSION['ds_email'] ?? ''; ?>" readonly>
          </div>
