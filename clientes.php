<div class="container">
    ...
    <form id="formCadastro" method="POST" enctype="multipart/form-data">
        ...
        <div class="checkbox">
            <input type="checkbox" id="estado_civil" name="estado_civil" value="casado">
        ...
        <div class="row mb-3">
            <div class="col-md-12 mt-3 d-flex align-items-center gap-3">
                ...
                <div id="preview-container">
                    <?php if (!empty($_SESSION['foto_cliente'])): ?>
                        <img src="uploads/<?php echo htmlspecialchars($_SESSION['foto_cliente']); ?>" alt="Foto do Cliente"
                            style="object-fit: cover; border-radius: 8px; width: 77px;">
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<script>
document.getElementById('foto_cliente').addEventListener('change', function (event) {
